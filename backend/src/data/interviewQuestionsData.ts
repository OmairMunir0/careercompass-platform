    ...
    Design: [
        {
            ...
            answer:
                "Product design focuses on functionality and user experience; graphic design focuses on visuals and branding. They collaborate via prototypes, branding guidelines, and visual storytelling."
        },
        {
            question: "How do you conduct research to validate a design concept before implementation?",
            answer:
                "Use surveys, interviews, market research, usability testing, and feedback sessions. Create personas and journey maps to align designs with user and business needs."
        },
        {
            question: "Describe accessibility (a11y) best practices in design.",
            answer:
                "Ensure readability, proper contrast, scalable typography, semantic structure, keyboard navigation, and testing for visual and cognitive accessibility."
        },
        {
            question: "What are design systems and how do they improve consistency and efficiency?",
            answer:
                "Reusable components, guidelines, and tokens (colors, spacing, typography). Tools: Figma, Storybook. Enforce consistency, reduce redesign, and speed up production."
        },
        {
            question: "Explain Fitts’s Law and how it applies to designing interactive elements.",
            answer:
                "Time to interact depends on distance and size. Apply by making frequent actions large and accessible, reducing effort and improving usability."
        },
        {
            question: "How do you design for multiple themes or environments while maintaining brand identity?",
            answer:
                "Define adaptable color palettes, typography, and elements; use variables; test contrast and readability; ensure brand recognition in all contexts."
        },
        {
            question: "What is Hick’s Law and how can it simplify design decision-making?",
            answer:
                "Decision time increases with the number of choices. Simplify by prioritizing actions, grouping options, and progressive disclosure to reduce cognitive load."
        },
        {
            question: "Describe the double diamond design process and its phases.",
            answer:
                "Discover (research), Define (problem), Develop (ideate solutions), Deliver (prototype/test). Divergent/convergent thinking ensures user-centered and effective designs."
        },
        {
            question: "How do you measure the success of a design using metrics and feedback?",
            answer:
                "Metrics: adoption rate, error rate, time to complete tasks. Feedback: surveys, interviews, usability tests. Combine quantitative and qualitative data for insights."
        },
        {
            question: "Explain micro-interactions and their role in enhancing design.",
            answer:
                "Small interactive details (like hover effects, loading indicators). They provide feedback, guide users, and make the experience engaging without distraction."
        },
    ],
    Management: [
        {
