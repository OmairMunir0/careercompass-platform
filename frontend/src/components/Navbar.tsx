...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white border-b border-purple-100 shadow-sm transition-colors duration-300 left-0 top-0 z-50">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900 transition-colors">SkillSeeker</span>
            </Link>
          </div>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="lg:hidden bg-white border-t border-gray-200 px-2 pt-2 pb-3 space-y-1 shadow-lg">
          {navItems.map((item) => {
            const Icon = item.icon;
            return (
              <Link
